...
#if we are doing feature extraction we don't have to do brackpropagation and so we disabled requires_grad
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):  #if we are in the train section we enable set_grad
...
model_ft, hist = train_model(model_ft, dataloaders, criterion, optimizer_ft, epochs)
#torch.save(model_ft, "drive/MyDrive/Image-Classification-Project/DenseNet.pt")
